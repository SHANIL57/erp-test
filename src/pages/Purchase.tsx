...
import { ShoppingCart, Plus, Eye, Edit2, Package } from 'lucide-react';

export default function Purchase() {
  const { parties, products, purchases, addPurchase } = useData();
  ...
  const handleProductChange = (index: number, field: string, value: any) => {
    ...
    if (field === 'productId') {
      ...
      if (product) {
        updated[index].price = product.purchasePrice;
      }
    }
      ...
      <div className="bg-white rounded-xl shadow-sm border border-orange-100 p-6">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left py-3 px-4 font-medium text-gray-700">Purchase #</th>
        ...
        {purchases.length === 0 && (
          <div className="text-center py-8">
            ...
            <p className="text-gray-500">No purchases found. Create your first purchase order.</p>
          </div>
        )}
      </div>
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-end space-x-3 pt-4">
            ...
            <button
              type="submit"
              disabled={!selectedParty || selectedProducts.length === 0}
